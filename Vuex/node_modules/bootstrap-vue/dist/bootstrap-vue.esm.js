...
var props$X = omit(props$W, ['header']); // @vue/component
...
Vue.extend({
  ...
  render: function render(h, _ref) {
    ...
    data.props = _objectSpread2({}, props, {
      header: true
    });
...
var props$Z = omit(props$W, ['header']); // @vue/component
